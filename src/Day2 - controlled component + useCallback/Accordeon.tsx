...
export function Accordeon(props: {qAs: QA[]}): ReactNode {
    const [openId, setOpenId] = useState<string | null>(null)
    
    const toggle = useCallback((id: string) => { setOpenId(id) }, [])
...
const Row = ({ qa, open, onToggle }: RowProps) => {
  useRenderCount(qa.id);             // tiny hook below
  return (
    <li>
